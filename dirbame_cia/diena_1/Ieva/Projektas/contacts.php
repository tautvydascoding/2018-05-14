          ...
          <div class="row mt-5">
              <main class=" col-md-6 mt-3 text-justify">
                <h4 class="textContact mt-5"> Contact Info: </h4>
                  ...
                  <div>
                    <img class="contactIcon mr-1" src="images/home.svg" alt="home icon" width="30px" height="30px" />
                    <p class="contactIcon textContact p-0"> <strong>Address:</strong> 10111 Santa Monica Boulevard, LA </p>
                  </div>

                  <div>
                    <img class="contactIcon mr-1" src="images/phone.svg" alt="phone icon" width="30px" height="30px" />
                    <p class="contactIcon textContact p-0"> <strong>Phone:</strong> +44 000 0008 </p>
                  </div>

                  <div>
                  <img class="contactIcon mr-1" src="images/mail.svg" alt="mail icon" width="30px" height="30px" />
                  <p class="contactIcon textContact p-0"> <strong>E-mail:</strong> info@Example.com </p>

                  </div>
              </main>

              <aside class="col-md-6 mt-3 d-flex">
