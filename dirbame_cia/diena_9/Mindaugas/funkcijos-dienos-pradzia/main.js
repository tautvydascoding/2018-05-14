...
function printDuomenys() {
  var vardas = "Tomas"; //locali funkcija
  console.log("vardas f-joje:" + vardas);
}
printDuomenys();
// console.log("vardas po f-ja:" + vardas); / Error nes localioje f-joje sukurtu funkciju negalima pasiekti
...
function testLocalVar() {
   var y = "y local";
   z = "z global"; // nereiketu taip daryti, neegzistuoja tol kol neiskvieciamas funkcija
   console.log("x", x); //prie global galima prieiti
   console.log("y", y);
   console.log("z", z);
}
testLocalVar();
...
//==========================
 ...
 function isvesti( xx ) {  // xx - (local) naujas issigalvotas LAIKINAS  kintamasis
     xx = 20;  // local  nereikia var, nes yra jau xx prie funkcijos
     console.log( "1. xx:", xx);
