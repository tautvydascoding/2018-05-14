...
//  var vardas = "Tomas"; //local kintamasis
...
//printDuomenys();
//console.log("Vardas už funkcijos:" + vardas); /// išmeta error, nepasiekia kintamojo už funckijos ribų nes kontamasis yra local
...
// }
//
// printAntraste("BMW pinga, nes daugeja" + "<br>");
// printAntraste("Greik pageres orai" + "<br>");
// printAntraste("Vasaros vis salteja" + "<br>");
//
// //  1.2 UZDUOTIS
...
printAntraste("Lorem1...." + "<br>");
printAntraste("Lorem2...." + "<br>");
printAntraste("Lorem3...." + "<br>");
