 ...
 ?>
    ...
    <!-- <h1 class="ml11">
      <span class="text-wrapper">
        ...
        <span class="letters">Ugdyti vaikučių asmenybę, savarankiškumą, pasitikėjimą savimi;</span>
      </span>
    </h1> -->

    <div class="container-fluid">
        <ul>
            <li class="ml11"><span class="text-wrapper">
              <span class="line line1"></span>
              <span class="letters">Ugdyti vaikučių asmenybę, savarankiškumą, pasitikėjimą savimi;</span>
            </span></li>
                ...
                <div class="col-md-6">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Mūsų įkūrėja ir vadovė - psicholingvistikos mokslų daktarė, kuriai labai rūpi vaikų kalba: kalbos įsisavinimas, kalbos raida, kalbos sutrikimai, dvikalbystė/daugiakalbystė, todėl gimus dukryte, įgyvendino seną svajonę kr įkūrė
                                “Smalsius šnekučius”.
                            </p>
                            <p>Telefonas:
