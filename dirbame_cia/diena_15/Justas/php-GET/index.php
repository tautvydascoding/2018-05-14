...
<html>
    ...
    <body>
        ...
        <form class="" action="registracija.php" method="get">
            ...
            <label for="telefononumeris">+370</label>
            <input type="tel" name="telefononumeris" value="" title="turi buti astuoni skaiciai be tarpu" placeholder="00000000" pattern="[0-9]{8}" required> <br>
            <input type="email" name="elpastas" value="" placeholder="xxx@xxx.lt"> <br>
