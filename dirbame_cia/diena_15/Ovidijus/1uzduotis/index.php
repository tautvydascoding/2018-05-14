...
<html>
    ...
    <body>
        ...
        <form action="registracija.php" method="get">
          ...
          <input type="text" name="pavarde" maxlength="20" placeholder="Jusu vardas" required> <br />
          <label for="">+370</label>
          <input type="tel" name="telefonas"  placeholder="0000 0000" pattern="[0-9]{8}" title="Tel numeris ne maziau 8 simboliu" required><br />
          <input type="email" name="elpastas" placeholder="aaa@aaa.lt" ><br />
