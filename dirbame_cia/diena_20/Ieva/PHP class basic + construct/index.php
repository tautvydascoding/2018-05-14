...
class Zmogus {
    ...
    public function printAmzius() {
      echo "Amzius: ". $this->amzius . "<br />";
    }
...
echo "zmogaus vardas:" . $zmogus1->name . "<br />";   // tomas
echo "zmogaus ugis:" . $zmogus1->ugis . "<br />";
// echo $zmogus1->amzius; //  Error: Cannot access private property Zmogus::$amzius
// kadangi amzius yra privatus, todel jo negalime paimti

class zmogus1 extends Zmogus {
