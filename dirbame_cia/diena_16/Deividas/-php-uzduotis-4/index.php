...
<html>
    ...
    <body >
        ...
        <?php
           require_once('db_functions.php');
             ...
             // //print_r($visiGydytojaiObjektas);
             //
             //
             //  $gydytojas1 = mysqli_fetch_assoc(  $visiGydytojaiObjektas    );
  ...
  $gydytojas = mysqli_fetch_assoc(  $visiGydytojaiObjektas    );
      ...
      while ( $gydytojas = mysqli_fetch_assoc(  $visiGydytojaiObjektas    )) {
        ...
        $gydytojas = mysqli_fetch_assoc(  $visiGydytojaiObjektas    ); // !!!!!!!
        <a class="btn btn-succes" href="delete-doctor.php"></a>
      }
...
<button  class="btn btn-success" href="delete-doctor.php" type="submit" name="button"> Registruotis</button>
<a class="btn btn-succes" href="delete-doctor.php"></a>
