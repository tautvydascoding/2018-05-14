...
$gydytojas1 = mysqli_fetch_assoc( $visiGydytojaiObjektas ); // Paimam SEKANTI tik VIENA eilute
$gydytojas2 = mysqli_fetch_assoc( $visiGydytojaiObjektas ); // Paimam SEKANTI tik VIENA eilute
$gydytojas3 = mysqli_fetch_assoc( $visiGydytojaiObjektas ); // Paimam SEKANTI tik VIENA eilute
$gydytojas4 = mysqli_fetch_assoc( $visiGydytojaiObjektas ); // Paimam SEKANTI tik VIENA eilute
